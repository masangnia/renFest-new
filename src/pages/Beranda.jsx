...
const Beranda = () => {
  ...
  return (
    <div className="beranda">
      <header className="container mx-auto py-4 flex flex-row justify-between items-center my-32">
        <div className="w-auto flex-col animate-fadeInUp">
          ...
          <p className="text-lg text-justify my-8 text-[#303030] pr-40">
            Selamat datang di Layanan Informasi Sewa Alat Terpercaya, Temukan
            Beragam Alat Berkualitas Tinggi dan Layanan Prima untuk Memenuhi
            Kebutuhan Proyek atau Acara Anda dengan Fleksibilitas dan Kemudahan
      ...
      <section
        className="bg-cover bg-center mt-48"
        style={{ backgroundImage: `url(${rentfestBackground})` }}
      >
        <div className="container mx-auto text-center py-16">
          <h3
            className="text-5xl font-bold mb-8 text-[#f5f5f5]"
            data-aos="fade-up"
          >
            Apa Itu RentFest?
          </h3>
          <div className="px-0 mx-auto">
            <p
              className="text-lg px-24 text-[#f5f5f5] font-light"
              data-aos="fade-up"
            >
              <strong className="font-bold">RentFest</strong> adalah website
              pelayanan service yang menghubungkan antara pelanggan dengan
              penyedia jasa rental peralatan untuk keperluan acara kampus dan
              lainnya, dengan fokus pada memberikan akses mudah dan informasi
              yang akurat. Platform ini akan menyediakan data lengkap tentang
              lokasi penyewaan alat, deskripsi peralatan yang tersedia, serta
              harga sewa yang transparan. Selain itu, informasi platform akan
              terhubung secara langsung dengan penyedia jasa rental alat untuk
              memastikan ketersediaan informasi yang akurat dan real-time bagi
              pengguna.
            </p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-8 mt-40">
        <h3 className="text-5xl text-center font-bold mb-8" data-aos="fade-up">
          Kenapa RentFest?
        </h3>
        <div
          className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-justify"
          data-aos="fade-up"
        >
          <div className="card p-6 rounded-2xl">
            <h4 className="text-xl font-semibold">Pencarian Alat Yang Cepat</h4>
            <p className="text-base mt-2">
              Pencarian yang canggih, pengguna dapat dengan mudah menemukan alat
          ...
          <div className="card p-6 rounded-2xl">
            ...
            <p className="text-base mt-2">
              Memberikan saran atau rekomendasi tentang alat-alat yang sesuai
          ...
          <div className="card p-6 rounded-2xl">
            ...
            <p className="text-base mt-2">
              Melihat ulasan dari pengguna lain tentang alat-alat tertentu,
              membantu mereka membuat keputusan yang lebih terinformasi.
            </p>
          </div>
        </div>
      </section>
        ...
        >
          <div className="relative group shadow-2xl cursor-default">
            ...
            <div className="absolute inset-0 bg-[#1b1a55] bg-opacity-60 flex items-center justify-center rounded-2xl group-hover:bg-opacity-0 transition duration-300">
              <span className="text-white text-3xl font-semibold group-hover:opacity-0 transition duration-300">
                Kamera
              </span>
            </div>
          </div>
      ...
      <section className="fitur container mx-auto my-40 px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center px-40">
          <div className="p-6 group rounded-2xl bg-[#eaeaea] shadow-2xl">
            <h4 className="text-xl font-semibold">REKOMENDASI ALAT</h4>
            <p className="text-base mt-2">
              Rekomendasi alat-alat yang paling cocok untuk kebutuhan Anda,
              memudahkan dalam pengambilan keputusan. Hal ini sangat membantu
              anda dan tidak akan pusing lagi memikirkan alat yang akan disewa.
            </p>
            <button
              className="px-h6 py-2 rounded-lg mt-4 text-lg"
          ...
          <div className="p-6 group rounded-2xl bg-[#eaeaea] shadow-2xl">
            ...
            <p className="text-base mt-2">
              Hemat waktu dan usaha dengan memilih paket acara yang sudah
              termasuk berbagai alat yang dibutuhkan untuk acara Anda,
              memberikan kenyamanan dan kemudahan ekstra dalam perencanaan
              acara. Acara anda akan terasa terbantu dengan fitur ini.
            </p>
            <button className="px-6 py-2 rounded-lg mt-4 text-lg">
              Selengkapnya
            </button>
          </div>
        </div>
            ...
            <Slider {...settings}>
              <div className="p-6">
                ...
                <p className="text-base mb-4">
                  Layanan yang sangat membantu! Saya bisa menemukan semua alat
                  yang saya butuhkan dengan cepat dan mudah.
                </p>
                <div className="flex">
                  <img
                    src={user}
              ...
              <div className="p-6">
                ...
                <p className="text-base mb-4">
                  RentFest sangat memudahkan dalam mencari peralatan untuk acara
                  kampus kami. Sangat direkomendasikan! :D
                </p>
                <div className="flex">
                  <img
                    src={user}
              ...
              <div className="p-6">
                ...
                <p className="text-base mb-4">
                  Platform yang luar biasa! Saya bisa menemukan alat yang saya
                  butuhkan dan melihat ulasan dari pengguna lain.
                </p>
                <div className="flex">
                  <img
                    src={user}
